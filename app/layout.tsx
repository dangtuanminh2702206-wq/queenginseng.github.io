...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Queen Ginseng Vietnam | Sâm Nữ Hoàng G8", description: "Sâm Nữ Hoàng G8 – Trà Sâm Hòa Tan, 30 gói × 15 g.", images: [`${basePath}/images/products/g8/g8-open-box-clean.webp`] },
